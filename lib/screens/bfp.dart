...
class _BFPPageState extends State<BFPPage> {
  ...
  Future<void> _initialize() async {
    try {
      ...
      if (username == null || municipality == null || municipality.isEmpty || role != 'bfp') {
        if (mounted) {
  ...
  void _initializeSocket() {
    try {
      ...
      socket!.on('redirected_alert', (data) {
        ...
        if (alert['target_role'] == 'bfp' && mounted) {
          setState(() {
      ...
      socket!.on('bfp_response', (data) {
        print('Received bfp_response: $data');
      });
                            ...
                            children: [
                              ...
                              ResponseForm(
                                ...
                                onUpdateEmergencyType: (id, brgy, typ, [hospital]) {
                                  ...
                                  socket?.emit('bfp_response', responseData);
                                },
                              ),
                            ],
                          );
