...
class _PNPPageState extends State<PNPPage> {
  ...
  Future<void> _initialize() async {
    try {
      ...
      if (username == null || municipality == null || municipality.isEmpty || role != 'pnp') {
        if (mounted) {
  ...
  void _initializeSocket() {
    try {
      ...
      socket!.on('pnp_redirect_alert', (data) {
        print('Received pnp_redirect_alert: $data');
      ...
      socket!.on('pnp_response', (data) {
        print('Received pnp_response: $data');
      });
  ...
  String _getSocketEvent(String type) {
    if (type == 'Road Accident') return 'pnp_response';
    if (type == 'Fire Incident') return 'pnp_fire_submitted';
    if (type == 'Crime Incident') return 'pnp_crime_response';
    return 'pnp_response';
  }
                    ...
                    Expanded(
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final String type = alert['emergency_type'] ?? 'N/A';
                          final String socketEvent = _getSocketEvent(type);
